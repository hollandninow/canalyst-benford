...
(0, _autocomplete.autocomplete)(tickerInput, ['AAPL US', 'JPM US', 'ATKR US']);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 21:
          ...
          (0, _alerts.displayAlert)(chartWindow, 'error', _context2.t0.response.data);
        case 24:
          if (!ticker) {
            _context2.next = 38;
            break;
        ...
        case 34:
          ...
          (0, _alerts.displayAlert)(chartWindow, 'error', _context2.t1.response.data);
        case 38:
