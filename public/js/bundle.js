...
exports.runCompanyAnalysis = void 0;
...
var chartWindowText = document.querySelector('.chart-window-text');

// DELEGATION
analysisForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var ticker, sector, token, data, iframe;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          ...
          token = document.getElementById('token').value; // TODO: add loading graphic
          ...
          _context.next = 9;
          return (0, _runAnalysis.runCompanyAnalysis)(token, ticker, 'Bloomberg', 'Income Statement As Reported,Balance Sheet,Cash Flow Statement,Adjusted Numbers As Reported');
        case 9:
          data = _context.sent;
