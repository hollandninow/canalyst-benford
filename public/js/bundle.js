...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"runAnalysis.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.runSectorAnalysis = exports.runCompanyAnalysis = void 0;
...
var runCompanyAnalysis = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(token, ticker, tickerType, fsString) {
    var res;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "api/v1/analysis/company?ticker=".concat(ticker, "&tickerType=").concat(tickerType, "&fsString=").concat(fsString, "&token=").concat(token)
          });
        case 3:
          res = _context.sent;
  ...
  return function runCompanyAnalysis(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
exports.runCompanyAnalysis = runCompanyAnalysis;
var runSectorAnalysis = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(token, sector, fsString) {
    var res;
  ...
  return function runSectorAnalysis(_x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();
exports.runSectorAnalysis = runSectorAnalysis;
...
var displayAlert = function displayAlert(parentEl, type, message) {
  hideAlert();
  parentEl.innerHTML = '';
  var msg = parseAlertMessage(message);
  ...
  input.addEventListener('input', function (e) {
    ...
    array.forEach(function (item, index) {
      if (item.substr(0, val.length).toUpperCase() === val.toUpperCase()) {
        ...
        listItem.innerHTML = "<strong>".concat(item.substr(0, val.length), "</strong>").concat(item.substr(val.length));
        listItem.innerHTML += "<input type='hidden' value='".concat(item, "'>");
...
},{}],"loadList.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var loadTickerList = /*#__PURE__*/function () {
  ...
  return function loadTickerList(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
},{"axios":"../../node_modules/axios/index.js"}],"button.js":[function(require,module,exports) {
exports.disableButton = function (btn) {
  btn.disabled = true;
};
exports.enableButton = function (btn) {
  btn.disabled = false;
};
...
var _runAnalysis = require("./runAnalysis");
var _alerts = require("./alerts");
var _cookie = require("./cookie");
var _autocomplete = require("./autocomplete");
var _loadList = require("./loadList");
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
// DOM ELEMENTS
var analysisForm = document.querySelector('.form__analysis');
var tokenForm = document.querySelector('.form__token');
var chartWindow = document.querySelector('.chart-window');
...
var runAnalysisBtn = document.querySelector('.button__run-analysis');
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          _context.next = 4;
          return (0, _loadList.loadTickerList)((0, _cookie.getCookie)('jwt'));
        case 4:
          tickers = _context.sent.data.data.tickers;
          (0, _autocomplete.autocomplete)(tickerInput, tickers);
          tickersLoaded = true;
        case 7:
        case "end":
          return _context.stop();
...
// Save token
tokenForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          (0, _cookie.setCookie)('jwt', token, 7);
        case 3:
        case "end":
...
analysisForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(e) {
    var ticker, sector, token, fsString, data, markupArray, sectorListItem, _data;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 17:
          ...
          (0, _button.enableButton)(runAnalysisBtn);
          markupArray.forEach(function (markup, index) {
...
var displayChart = function displayChart(parentEl, markup) {
...
var displaySelectionList = function displaySelectionList() {
...
var displaySelectionListItem = function displaySelectionListItem() {
  ...
  var selectionListItem = parentEl.appendChild(document.createElement('li'));
  selectionListItem.classList.add('selection-list-item');
  var selectionListItemSpan = selectionListItem.appendChild(document.createElement('span'));
  if (sector) {
  ...
  var name = getNameFromMarkup(markup);
  ...
  if (!sector) {
    ...
    var ticker = getTickerFromMarkup(markup);
